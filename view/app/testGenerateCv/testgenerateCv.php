...
<div id="form" style="float: left;margin-left: 10px;width: 40%;">
    <form action="#" method="post">
        ...
        echo $form->input('titre', 'Votre titre', null, null, 'onKeyup(this,\'titreCV\')');
        echo $form->error('titre');
        echo "<br>" . $form->label('nom et prénom : ');
        echo $form->input('nom', 'Votre nom et prénom',  null, null, 'onKeyup(this,\'nomSurname\')');
        echo $form->error('nom');
        echo "<br>" . $form->label('n° de rue : ');
        echo $form->input('numAdress', 'Votre numéro de rue', null, null, 'onKeyup(this,\'num\')');
        echo $form->error('numAdress');
        echo "<br>" . $form->label('nom de rue : ');
        echo $form->input('street', 'Votre nom de rue', null, null, 'onKeyup(this,\'nameStreet\')');
        echo $form->error('street');
        echo "<br>" . $form->label('code postal : ');
        echo $form->input('codePostal', 'Votre code postal', null, null, 'onKeyup(this,\'postalCode\')');
        echo $form->error('codePostal');
        echo "<br>" . $form->label('ville : ');
        echo $form->input('city', 'Votre ville', null, null, 'onKeyup(this,\'nameCity\')');
        echo $form->error('city');
        echo "<br>" . $form->label('n° de téléphone : ');
        echo $form->input('phone', 'Votre numéro de téléphone', null, null, 'onKeyup(this,\'phoneNumber\')');
        echo $form->error('phone');
        echo "<br>" . $form->label('adresse mail : ');
        echo $form->input('mail', 'Votre adresse mail', null, null, 'onKeyup(this,\'mailAdress\')');
        echo $form->error('mail');
        echo "<br>" . $form->label('lien(s) : ');
        echo $form->input('lien', 'Votre lien', null, null, 'onKeyup(this,\'lienInternet\')', 'liste-liens');
        ...
        echo $form->input('experienceName', null, 'Votre nom d\'expérience', null, 'onKeyup(this,\'nameExperience\')');
        echo $form->error('experienceName');
        echo "<br>" . $form->label('date de votre experience : ');
        echo $form->input('experienceDate', 'Votre date d\'expérience', null, null, 'onKeyup(this,\'dateExperience\')');
        echo $form->error('experienceDate');
        echo "<br>" . $form->label('ville de votre expérience : ');
        echo $form->input('experienceCity', 'Votre ville d\'expérience', null, null, 'onKeyup(this,\'cityExperience\')');
        ...
        echo $form->input('formationName', 'Votre nom de formation', null, null, 'onKeyup(this,\'nameFormation\')');
        echo $form->error('formationName');
        echo "<br>" . $form->label('date de votre formation : ');
        echo $form->input('formationDate', 'Votre date de formation', null, null, 'onKeyup(this,\'dateFormation\')');
        echo $form->error('formationDate');
        echo "<br>" . $form->label('ville de votre formation : ');
        echo $form->input('formationCity', 'Votre ville de formation', null, null, 'onKeyup(this,\'cityFormation\')');
